...
public class IntegListener implements ActionListener {
    private JTextField tf1;
    private JTextField tf2;
    private JTextField res1;
    private JTextField res2;

    public IntegListener(JTextField tf1, JTextField tf2, JTextField res1, JTextField res2) {
        this.tf1 = tf1;
        this.tf2 = tf2;
        this.res1 = res1;
        this.res2 = res2;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        res1.setText(p1.integrare());
        res2.setText(p2.integrare());
